...
- [x] Chạy thử trên 1 sự cố lịch sử (tái hiện từ `onboarding/INCIDENT_HISTORY.md`): pack ra trong 30 phút, người CDO đọc hiểu không cần hỏi AIO.
- [x] Template trống tồn tại làm fallback.
- [x] Kênh #tf3-changes có và cả TF đã thống nhất format `[change]`.
- [x] ADR ký tên.
