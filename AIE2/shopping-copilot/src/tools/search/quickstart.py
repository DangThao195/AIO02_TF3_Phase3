...
Chạy: python -m src.tools.search.quickstart
"""
...
def suggest_next_steps(groq_ok, port_ok, deps_ok):
    ...
    print("     python tests/test_search/test_e2e.py \"kính thiên văn dưới 100 đô\"\n")
    print("  2️⃣  Batch test (6 predefined queries):")
    print("     python tests/test_search/test_e2e.py --batch\n")
    print("  3️⃣  Multiple custom queries:")
    print("     python tests/test_search/test_e2e.py \"query1\" \"query2\" \"query3\"\n")
