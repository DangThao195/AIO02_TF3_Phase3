...
| **T5 24/07** | - Hỗ trợ kiểm định chéo & nghiệm thu eval                                                                                                                  | - Tái kiểm thử & Thu thập bằng chứng chạy thật cho Ticket 1 (1.6)                                                                                    | - Triển khai kiểm thử liên kết & nghiệm thu (3.5)                                                                                                                                     |
| **T6 25/07** | - Nghiệm thu & Nộp Jira Ticket `AI MANDATE #14`                                                                                                            | - Nghiệm thu & Nộp Jira Ticket `AI MANDATE #14`                                                                                                      | - Nghiệm thu & Nộp Jira Ticket `AI MANDATE #22`                                                                                                                                       |
