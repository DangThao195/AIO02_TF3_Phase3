...
* **Tài liệu quyết định kiến trúc**: Xem tại **[0007-FALLBACK-OVERRIDE-AND-TELEMETRY.md](../adr/0007-FALLBACK-OVERRIDE-AND-TELEMETRY.md)**.
...
* **Tài liệu đề xuất chi tiết**: Xem tại **[LLM_CACHING_DESIGN.md](../analysis/LLM_CACHING_DESIGN.md)**.
...
* **Tài liệu đề xuất chi tiết**: Xem tại **[0003-LLM-RETRY-BACKOFF.md](../analysis/0003-LLM-RETRY-BACKOFF.md)**.
...
* **Tài liệu đề xuất chi tiết**: Xem tại **[LLM_STREAMING.md](../analysis/LLM_STREAMING.md)**.
...
* **Tài liệu đề xuất chi tiết**: Xem tại **[LLM_DYNAMIC_TOOL_REGISTRY.md](../analysis/LLM_DYNAMIC_TOOL_REGISTRY.md)**.
...
* **Tài liệu đề xuất chi tiết**: Xem tại **[LLM_CONVERSATION_MEMORY.md](../analysis/LLM_CONVERSATION_MEMORY.md)**.

---

## 📁 3. Bản Đồ Thư Mục Của Nhóm AIE1

Toàn bộ các tài liệu và phần việc liên quan của nhóm AIE1 được tổ chức ngăn nắp tại thư mục gốc dự án:

* **[AI_BASELINE_EVAL.md](../../AI_BASELINE_EVAL.md)**: Nhật ký đo đạc Baseline (độ trễ, chi phí token), thiết kế Guardrails và Backlog cải tiến.
* **[docs/adr/](../adr)**: Quyết định thiết kế kiến trúc (ADR 0003 – ADR 0009).
* **[docs/analysis/](../analysis)**: Các báo cáo phân tích thiết kế bao gồm:
  * Lỗi hệ thống đánh giá: **[0002-EVALUATION-BOTTLENECKS.md](../analysis/0002-EVALUATION-BOTTLENECKS.md)**
  * Tích hợp `boto3` trực tiếp: **[0004-BEDROCK-INTEGRATION-PROPOSAL.md](../analysis/0004-BEDROCK-INTEGRATION-PROPOSAL.md)**
  * Thiết kế Caching: **[LLM_CACHING_DESIGN.md](../analysis/LLM_CACHING_DESIGN.md)**
  * Thử lại và trễ lũy thừa: **[0003-LLM-RETRY-BACKOFF.md](../analysis/0003-LLM-RETRY-BACKOFF.md)**
  * Phản hồi dạng luồng: **[LLM_STREAMING.md](../analysis/LLM_STREAMING.md)**
  * Đăng ký công cụ động: **[LLM_DYNAMIC_TOOL_REGISTRY.md](../analysis/LLM_DYNAMIC_TOOL_REGISTRY.md)**
  * Bộ nhớ hội thoại: **[LLM_CONVERSATION_MEMORY.md](../analysis/LLM_CONVERSATION_MEMORY.md)**
* **[EKS_DEPLOY_GUIDE.md](./EKS_DEPLOY_GUIDE.md)**: Hướng dẫn chi tiết các bước deploy cụ thể lên cluster Kubernetes EKS.
* **[product-reviews](../../techx-corp-platform/src/product-reviews)**: Mã nguồn Python của dịch vụ product reviews.
