...
### Trên Linux / macOS / Git Bash (POSIX shell)
```bash
python3 -m venv venv
...
## 🚀 6. Khởi chạy dịch vụ `product-reviews` trên host

Mở Terminal 1 và cấu hình biến môi trường rồi khởi chạy dịch vụ:
...
Mở Terminal 2 và kích hoạt môi trường ảo `venv` rồi chạy client mẫu:
...
### Một số kịch bản kiểm tra nhanh:
